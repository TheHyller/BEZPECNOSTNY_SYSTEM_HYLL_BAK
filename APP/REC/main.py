...
class MainApp(App):
    ...
    def handle_status_message(self, device_id, status):
        ...
        from REC.config.devices_manager import devices_manager
        from REC.config.system_state import system_state
        ...
        if isinstance(status, dict):
            ...
            if not devices_manager.device_exists(device_id):
                ...
                ns.add_notification(f"Nájdené nové zariadenie: {device_name}")
